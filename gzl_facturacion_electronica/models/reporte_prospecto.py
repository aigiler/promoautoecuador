...
class ReportCrm(models.TransientModel):
    ...
    def print_report_xls(self):
        ...
        name = 'REPORTE DE CIERRE '+ str(today.year)
    ...
    def xslx_body(self,workbook,name):
        ...
        sheet.merge_range('A2:I2', 'REPORTE DE CIERRE DEL '+str(dia_start)+' DE '+str(mesesDic[str(mes_start)])+' DEL '+str(year)+' AL '+str(dia_end)+' DE '+str(mesesDic[str(mes_end)])+' DEL '+str(year), bold)
