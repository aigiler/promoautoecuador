...
class ReporteEstadoDeCuenta(models.TransientModel):
    ...
    def xslx_body(self, workbook, name):
        ...
        sheet.write('J10', 'Tipo de contrato: '+ self.contrato_id.tipo_de_contrato.name.upper(), format_datos)
        sheet.write('J12', 'Monto financiamiento: $'+ str(self.contrato_id.monto_financiamiento), format_datos)
