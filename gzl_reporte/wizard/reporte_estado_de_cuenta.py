...
class ReporteEstadoDeCuenta(models.TransientModel):
    ...
    def xslx_body(self, workbook, name):
        ...
        formato_cabecera_tabla = workbook.add_format({'font_name':'Arial','font_size':  11,'align':'center','bold':True, 'bottom':1, 'top':1,'text_wrap':True})
        formato_pie_tabla = workbook.add_format({'font_name':'Arial','font_size':  11,'align':'left','bold':True, 'bottom':1, 'top':1})
        date_format = workbook.add_format({'font_name':'Arial','font_size':  11,'num_format': 'yyyy-mm-dd', 'align': 'center','text_wrap': True })
        ...
        body = workbook.add_format({'align': 'center','font_name':'Arial','font_size':11,'align': 'left','border':0,'text_wrap': True})
