...
class ReportGrupos(models.TransientModel):
    ...
    def xslx_body(self,workbook,name):
        ...
        for line in lista_final:
            ...
            sheet.write(row, 46, line['capital_por_cobrar'], formato_numero)
            sheet.write(row, 47, line['sum_adm_iva'], formato_numero)
            sheet.write(row, 48, line['administrativo_pagado'], formato_numero)
            sheet.write(row, 49, line['administrativo_total'], formato_numero)
            sheet.write(row, 50, line['administrativo_por_cobrar'], formato_numero)
            sheet.write(row, 51, line['iva_pagado'], formato_numero)
            sheet.write(row, 52, line['iva_total'], formato_numero)
            sheet.write(row, 53, line['iva_por_cobrar'], formato_numero)
            sheet.write(row, 54, line['sum_adm_iva_total'], formato_numero)
