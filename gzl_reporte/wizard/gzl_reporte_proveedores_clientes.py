...
##### Calculo de saldos debe ser cambiado
            ...
            if dias>0:  
                ...
                if dias>120:
                    dct['120']=factura.amount_total - pagos
                elif dias>90 and dias<120:
                    dct['91_120']=factura.amount_total - pagos
                elif dias>60 and dias <=90:
                    dct['61_90']=factura.amount_total - pagos
                elif dias>30 and dias<=60:
                    dct['31_60']=factura.amount_total - pagos
                elif dias>0 and dias <=30:
                    dct['1_30']=factura.amount_total - pagos
            else:
                dct['dias_vencidos']=0
                if abs(dias)>90:
                    dct['91_por_vencer']=factura.amount_total - pagos
                elif abs(dias)>60 and abs(dias) <=90:
                    dct['61_90_por_vencer']=factura.amount_total - pagos
                elif abs(delta.days)>30 and abs(dias) <=60:
                    dct['31_60_por_vencer']=factura.amount_total - pagos
                elif abs(dias)>1 and abs(dias) <=30:
                    dct['1_30_por_vencer']=factura.amount_total - pagos
