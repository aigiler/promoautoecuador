...
class InformeCreditoCrobranza(models.TransientModel):
    ...
    def crear_plantilla_informe(self):
        ...
        if self.plantilla_dinamica.identificador_clave=='informe_alarmas':
            self.crear_plantilla_informe_alarma()

        if self.plantilla_dinamica.identificador_clave=='informe_cctv':
            self.crear_plantilla_informe_cctv()


        if self.plantilla_dinamica.identificador_clave=='informe_checklist_vigilancia':
            self.crear_plantilla_informe_checklist_vigilancia()



    def crear_plantilla_informe_checklist_vigilancia(self):
