...
class ReportComisiones(models.TransientModel):
    ...
    def xslx_body(self,workbook,name):
        ...
        sheet.write(2, 4, 'SUBTOTAL', bold2)
        sheet.write(2, 4, 'IVA', bold2)
        sheet.write(2, 4, 'TOTAL A RECIBIR', bold2)
        sheet.write(2, 4, 'ESTADO', bold2)
        sheet.write(2, 4, 'OBSERVACION', bold2)
