...
class ReportComisiones(models.TransientModel):
    ...
    def print_report_xls(self):
        ...
        name = 'Comisiones '+ str(today.year)
    ...
    def xslx_body(self,workbook,name):
        ...
        sheet.write(2, 0, 'PERIODO DE PAGO', format_title)
        sheet.write(2, 1, 'CARGO', format_title)
        sheet.write(2, 2, 'AGENCIA', format_title)
        sheet.write(2, 3, 'CONTRATO N', format_title)
        sheet.write(2, 4, 'NOMBRE', format_title)
        sheet.write(2, 4, 'SUBTOTAL', format_title)
        sheet.write(2, 4, 'IVA', format_title)
        sheet.write(2, 4, 'TOTAL A RECIBIR', format_title)
        sheet.write(2, 4, 'ESTADO', format_title)
        sheet.write(2, 4, 'OBSERVACION', format_title)
        row=3
        #for l in data:
