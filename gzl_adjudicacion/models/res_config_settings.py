...
class ResConfigSettings(models.TransientModel):
    ...
    configuracion_adicional=fields.Many2one('configuracion.adicional.template',string="Configuracion Adicional",default=self.env.ref('gzl_adjudicacion.configuracion_adicional1'))
