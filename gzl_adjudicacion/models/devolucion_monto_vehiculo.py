...
###REQUISITOS
    ...
    rolAsignado = fields.Many2one('adjudicaciones.team', string="Rol Asignado", track_visibility='onchange',default=lambda self:self.env.ref('gzl_adjudicacion.tipo_rol5'))
    ...
    def validarrol(self):
        ...
        for x in roles:
          if self.env.user.id in x.member_ids:
            result = True
          else:
