...
class ReporteEstadoCuenta(models.TransientModel):
        ...
        for factura in lista_facturas:
            ...
            for cap in  capital_fac:
                dct={'fecha_emision':cap.date,
                    ...
                    'documento_contable':cap.journal_id.name,
            ...
            for seg in  seguro_fac:
                dct={'fecha_emision':seg.date,
                    ...
                    'tipo_invoice':'INT',
                    'referencia':factura['referencia'],
                    'documento_contable':seg.journal_id.name,
                    'observaciones':factura['secuencia'],
                    'monto_adeudado':0,
                    'debe':seg.amount_total_signed,
                    'haber':0}
            ...
            for ras in  rastreo_fac:
                dct={'fecha_emision':ras.date,
                    ...
                    'tipo_invoice':'INT',
                    'referencia':factura['referencia'],
                    'documento_contable':ras.journal_id.name,
                    'observaciones':factura['secuencia'],
                    'monto_adeudado':0,
                    'debe':ras.amount_total_signed,
                    'haber':0}
            ...
            for otr in  otros_fac:
                dct={'fecha_emision':otr.date,
                    ...
                    'tipo_invoice':'INT',
                    'referencia':factura['referencia'],
                    'documento_contable':otr.journal_id.name,
                    'observaciones':factura['secuencia'],
                    'monto_adeudado':0,
                    'debe':otr.amount_total_signed,
                    'haber':0}
    ...
    def print_report_pdf(self):
        return self.env.ref('gzl_reporte_financieros.repote_estado_cuenta_pdf_id').report_action(self)
